...
\caption{Mean forecast-window CRPS by model family and cutoff. Lower values are better. For families with multiple \(\epsilon\)/\(c\)-factor settings, the reported entry is the best mean CRPS attained within that family at the cutoff; bold indicates the lowest CRPS within each cutoff column.}
